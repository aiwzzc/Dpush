...
LogicServer::LogicServer(MySQLConnPool* mysql, sw::redis::Redis* redis, threadpool* thread) : 
...
std::string SerializeMessageToJson(const Message& msg) {
    Json::Value root;
...
grpc::ServerUnaryReactor* LogicServer::clientMessage(grpc::CallbackServerContext* context, const logic::clientMessageRequest* request, 
...
DetachedTask LogicServer::DoclientMessage(grpc::ServerUnaryReactor* reactor, const logic::clientMessageRequest* request, 
    logic::clientMessageResponse* response) {
...
grpc::ServerUnaryReactor* LogicServer::clearCursors(grpc::CallbackServerContext* context, const logic::clearCursorsRequest* request, 
...
DetachedTask LogicServer::DoclearCursors(grpc::ServerUnaryReactor* reactor, const logic::clearCursorsRequest* request,
    logic::clearCursorsResponse* response) {
